...
export const chatResponseSchema = z.object({
  ...
  sources: z.preprocess(
    (val) => Array.isArray(val) ? val.filter(item => item && typeof item === 'object' && !Array.isArray(item) && 'platform' in item) : [],
    z.array(z.object({
  ...
  recommendations: z.preprocess(
    ...
    (val) => Array.isArray(val) ? val.filter(item => item && typeof item === 'object' && !Array.isArray(item) && 'name' in item) : [],
    z.array(z.object({
  ...
  ask_question: z.preprocess(
    (val) => (val !== null && typeof val === 'object' && !Array.isArray(val)) ? val : null,
    z.object({
  ...
  ).describe("Optional follow-up interaction or null if answer is final."),
